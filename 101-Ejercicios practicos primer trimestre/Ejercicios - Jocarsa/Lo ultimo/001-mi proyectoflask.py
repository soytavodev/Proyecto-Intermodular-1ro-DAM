...
def raiz():                          # Defino una funcion
  cursor.execute("SELECT * FROM piezasportafolio_y_categoriasportafolio;")  # Pido el contenido de la vista
  ...
  <body>
    <header>
      <h1>Gustavo Delnardo</h1>
      <h2>gustavo1@gmail.com</h2>
    </header>
    <main>
